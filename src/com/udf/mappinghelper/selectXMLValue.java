...
public class selectXMLValue {

	public selectXMLValue(String[] xmllist, String keyfield, String keyvaluelist, String resultField,
					...
					for (int i = 0; i < tagslist.getLength(); i++) {
						...
						for (String keyvalue : keyvalues) {
							...
							if (nodename.equals(keyvalue)) {
								// add the content of the result field to the
								// output
